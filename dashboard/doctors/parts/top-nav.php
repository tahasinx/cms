...
<ul class="nav user-menu float-right">
                    ...
                    while ($row2 = $notifications->fetch_assoc()) {
                        ...
                        <li class="notification-message">
                            ...
                            <?php if ($row2['notification_type'] === 'appointment') { ?>
                                ...
                                <div class="media">
                                    <span class="avatar">
                                        <img alt="" src="assets/img/attachment.png" class="img-fluid">
                                    </span>
                                    <div class="media-body">
                                        <p class="noti-details"><span class="noti-title"><?php echo $server->getClient_NameByID($client_id) ?></span>&nbsp;<span class="noti-title"><?php echo $row2['notification_about'] ?></span></p>
    ...
    <li class="nav-item dropdown has-arrow">
        <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
            <span class="user-img">
                <img class="rounded-circle" src="<?php echo $row['propic']; ?>" style="height: 40px;width: 40px" onerror="this.onerror=null; this.src='assets/img/user.jpg'" alt="">
