...
<div class="main-wrapper">
    ...
    <div class="page-wrapper">
        <div class="content">
            ...
            <div class="row">
                <div class="col-sm-8 "><h4 class="page-title">Request Drugs:&emsp;<u>Upload Prescription</u></h4></div>
                <div class="col-sm-4 text-right m-b-20">
                    <a href="add-doctor.php" class="btn btn-primary btn-rounded float-right"><i class="fa fa-feed"></i>
                        Feedback</a>
                </div>
            </div>
                                                ...
                                                <td>
                                                    ...
                                                    <p>
                                                        ...
                                                        if ($row['is_pending'] == 1) {
                                                            ...
                                                            echo '<span style="color:blueviolet">Feedbacked</span>&nbsp;<a  href="check-feedback.php?url=request-drugs.php&request_id=' . $row['request_id'] . '&is_feedbacked=' . $row['is_feedbacked'] . '" style="color:orangered">check</a>';
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <form method="POST" action="">
                                                        ...
                                                        if ($row['is_pending'] == 1) {
                                                            ...
                                                            ?>
                                                            <a href="check-feedback.php?url=request-tests.php&request_id=<?= $row['request_id'] ?>&is_feedbacked=<?= $row['is_feedbacked'] ?>"
                                                               class="btn btn-outline-primary"
                                                               title="Check Feedback">
                                                                <i class="fa fa-feed"></i>
                                                            </a>
                                                            <button class="btn btn-outline-success bounceIn"
                                                                    type="submit" name="received"
                                                            ...
                                                            ?>
                                                            <a href="check-feedback.php?url=request-drugs.php&request_id=<?= $row['request_id'] ?>&is_feedbacked=<?= $row['is_feedbacked'] ?>"
                                                               class="btn btn-outline-primary"
                                                               title="Check Feedback">
                                                                <i class="fa fa-feed"></i>
                                                            </a>
