...
if (isset($_GET['view'])) {
    $data = $server->viewDoctorData($_GET);
}
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 col-9 text-right m-b-20">
                                ...
                                <form method="POST" action="update-doctor.php">
                                    <input type="hidden" name="doctor_id" value="<?php echo $row['user_id'] ?>" required/>
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="">
                                                        ...
                                                        <div class="staff-id">Doctor ID : <?php echo $row['user_id'] ?></div>
                                                        ...
                                                        <?php if ($row['certificate'] == "") { ?>
                                                            <a class="btn btn-danger">NO CERTIFICATE</a>
                                                        <?php }else{ ?>
                                                            <a class="btn btn-primary" href="<?php echo $row['certificate'] ?>" target="_blank">CERTIFICATE /LICENSE</a>
                                                        <?php } ?>
                                                        <br>
