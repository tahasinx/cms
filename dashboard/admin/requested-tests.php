...
<div class="main-wrapper">
    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="row">
                <div class="col-sm-8 "><h4 class="page-title"><u>Requested Tests</u></h4></div>
                <div class="col-sm-4 text-right m-b-20">
                    <a href="requested-drugs.php" class="btn btn-primary btn-rounded float-right"><i
                                                ...
                                                <td>
                                                    ...
                                                    <p>
                                                        ...
                                                        if ($row['is_pending'] == 1) {
                                                            ...
                                                            echo '<span style="color:blueviolet">Feedbacked</span>&nbsp;<a  href="check-feedback.php?url=requested-tests.php&request_id='.$row['request_id'].'" style="color:orangered">check</a>';
