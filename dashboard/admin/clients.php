                ...
                <div class="content">
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-9 text-right m-b-20">
                            <a href="clients.php" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> All Clients</a>
                        </div>
                    </div>
                                    ...
                                    <div class="profile-widget">
                                        ...
                                        <div class="dropdown profile-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a href="update-client.php?client_id=<?php echo $row['client_id'] ?>">
                                                    <span class="dropdown-item">
